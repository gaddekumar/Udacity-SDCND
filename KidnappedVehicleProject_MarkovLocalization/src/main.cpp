...
int main()
{
  ...
  h.onMessage([&pf,&map,&delta_t,&sensor_range,&sigma_pos,&sigma_landmark](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length, uWS::OpCode opCode) {
    ...
    {
      // This method is defined above. Checks whether the response from the simulator has data. 
      auto s = hasData(std::string(data));
      
      if (s != "") {

        // j is the json string for parsing.
        auto j = json::parse(s);
        ...
        if (event == "telemetry") {
          ...
          // Else: If the particle filter is already initialized.
          else {
          ...
          // back_inserter -> Inserts a new element at the end of x.
          // Insert elements automatically at the end of the container.
          ...
          // The above observations are the noisy observations from the simulator.
